...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/newsstorefront/electronics/en",
						"https://electronics.local:9002/newsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/newsstorefront/electronics/en",
						"https://electronics.local:9002/newsstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/newsstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/newsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/newsstorefront/electronics/en",
						"https://electronics.local:9002/newsstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/newsstorefront",
						"https://electronics.local:9002/newsstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/newsstorefront",
						"https://electronics.local:9002/newsstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/newsstorefront/electronics/en",
						"https://electronics.local:9002/newsstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
