 ...
 */
package my.news.core.constants;

/**
 * Global class for all NewsCore constants. You can add global constants for your extension into this class.
 */
public final class NewsCoreConstants extends GeneratedNewsCoreConstants
{
	public static final String EXTENSIONNAME = "newscore";


	private NewsCoreConstants()
	{
		//empty
	}
