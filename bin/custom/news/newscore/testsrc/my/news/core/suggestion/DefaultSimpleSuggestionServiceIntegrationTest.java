 ...
 */
package my.news.core.suggestion;
...
import my.news.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/newscore/test/testSimpleSuggestionService.csv", "utf-8");
	}
