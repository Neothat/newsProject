 ...
 */
package my.news.core.job;

import static my.news.core.job.QuoteToExpireSoonJobPerformable.DAYS_TO_EXPIRE;
import static my.news.core.job.QuoteToExpireSoonJobPerformable.DEFAULT_DAYS_TO_EXPIRE;
