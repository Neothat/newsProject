 ...
 */
package my.news.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(NewsFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(NewsFulfilmentProcessConstants.PARENT_PROCESS);
