 ...
 */
package my.news.fulfilmentprocess.test.jobs;
...
import my.news.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = NewsFulfilmentProcessConstants.ORDER_PROCESS_NAME;
